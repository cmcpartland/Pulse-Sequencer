 ...
 *It will remain high until a hardware or software reset occurs. 
 *At that point, it will stay low, '0', until the board is triggered again.
 *
 ...
 *             If an error occurs, returns an error code defined in \link spinpts.h \endlink
 */
...
/**
 * Decodes error codes defined in \link spinpts.h \endlink
 *
 ...
 * from a scan is being captured. However, this is not recommened since there
